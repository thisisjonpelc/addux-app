        ...
        return (
            <div className='share-page'>
                ...
                <div className='share-page__box'>
                    ...
                    >
                        <span className='btn btn--full-width share-page__button'>
                            Copy to clipboard
                        </span>
                    </CopyToClipboard>
                    <p className={`alert alert--success share-page__alert ${this.state.noCommentsCopied ? 'share-page__alert--reveal' : ''}`}>
                        Link Copied to Clipboard!
                    </p>
                </div>
                <div className='share-page__box'>
                    <p className='share-page__text'>
                        Use this link to share a copy of this addux 
                        <span className='underline'>with</span> 
                        comments:  
                        <input 
                            type='text' 
                            value={commentURL} 
                    ...
                    <p className={`alert alert--success share-page__alert ${this.state.withCommentsCopied ? 'share-page__alert--reveal' : ''}`}>
                        Link Copied to Clipboard!
                    </p>    
                </div>
                <button 
                    className='btn btn--width-200 share-page__pdf-buton' 
...
export default connect(mapStateToProps, {logout})(SharePage);
